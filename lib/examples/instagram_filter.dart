...
class ExampleInstagramFilterSelection extends StatefulWidget {
  ...
  @override
  _ExampleInstagramFilterSelectionState createState() => _ExampleInstagramFilterSelectionState();
}
          ...
          return Center(
            child: AnimatedBuilder(
              ...
              builder: (context, child) {
                ...
                final pageDistanceFromSelected = (selectedIndex - index + pageScrollAmount).abs();

                // The percent distance of this filter item from the
                // center of the carousel, i.e., where the selector
                // ring sits.
                final percentFromCenter = 1.0 - pageDistanceFromSelected / maxScrollDistance;
